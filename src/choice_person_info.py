...
if __name__ == "__main__":
    ...
    input_dir = "../data/results/dbscan/overall/20250530-1635-onlyPerson"          # たとえば "data/results/dbscan/overall/20250530-1635-onlyPerson"
    output_dir = "../data/choiced_person_info" # 好きな出力先ディレクトリを指定
