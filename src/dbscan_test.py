...
for i in range(max_label + 1):
    ...
    o3d.io.write_point_cloud(f"../data/results/dbscan/each_cluster/combined_data/cluster_{i:02d}.pcd", cluster)



# 全体（色付き）の点群も保存
o3d.io.write_point_cloud("../data/results/dbscan/overall/combined_data/colored_clusters.pcd", pcd)

# --- クラスタ情報をJSONで保存 ---
with open("../data/results/dbscan/each_cluster/combined_data/cluster_info.json", "w") as f:
