...
total_pcd_path = "/home/kenji/workspace/cpp/align_pcd/data/alignment_data/by_mimotos_matrix/combined_data/combined_81.pcd"
...
print("After voxel downsampling:", total_pcd)
...
o3d.io.write_point_cloud("../data/results/background_diff/combined_data/background_diff_0.pcd", background_diff_pcd)
